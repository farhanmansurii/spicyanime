function AnimeCard(props) {
  ...
  return (
    <div class="relative w-36 h-52 lg:w-40 lg:h-60  duration-100  overflow-hidden  rounded">
      ...
      <div class="absolute inset-0  bg-gradient-to-t flex flex-col-reverse duration-150 border-2 border-transparent hover:border-red-500 from-[#0b090a] to-transparent p-3">
