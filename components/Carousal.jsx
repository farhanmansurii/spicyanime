      ...
      <div className="z-50 flex lg:gap-3 flex-col absolute w-11/12 mx-auto justify-end uppercase inset-0">
        ...
        <div className="my-2 gap-2 flex">
          <Link href={`/${props.props.id}`}>
            <button className="p-2 lg:p-3 text-xs flex bg-red-500/50 border-2 border-black text-black backdrop-blur-sm hover:scale-110 hover:bg-black hover:text-red-500 duration-150 rounded-full">
              <svg
          ...
          <button className="p-2 lg:p-3 text-xs bg-black/50 border-2 border-red-500/50 text-red-500 hover:scale-110 hover:bg-red-500 hover:text-black hover:rotate-180 duration-150 rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
